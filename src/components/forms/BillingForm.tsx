...
import { calculateBillingFields, generateBillNumber, formatCurrency } from '@/utils/billingCalculations';
    ...
    <Card className="bg-card border-border">
      <CardHeader>
        <CardTitle className="flex items-center space-x-2">
          ...
          <span>Add New Billing Record</span>
        </CardTitle>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {isCalculated && (
            <div className="space-y-4 p-4 bg-secondary/30 rounded-lg border border-border">
              <h3 className="font-medium text-foreground mb-3">Calculated Fields</h3>
